...
# Form implementation generated from reading ui file 'LoginSuper.ui'
#
...
class Ui_LoginSuper(object):
    def setupUi(self, LoginSuper):
        LoginSuper.setObjectName("LoginSuper")
        LoginSuper.resize(1250, 809)
        LoginSuper.setMinimumSize(QtCore.QSize(700, 500))
        self.horizontalLayout = QtWidgets.QHBoxLayout(LoginSuper)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setSpacing(0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.label = QtWidgets.QLabel(LoginSuper)
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/images/library-3.png"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.horizontalLayout.addWidget(self.label)
        self.widget = QtWidgets.QWidget(LoginSuper)
...
"}")
        ...
        self.retranslateUi(LoginSuper)
        QtCore.QMetaObject.connectSlotsByName(LoginSuper)

    def retranslateUi(self, LoginSuper):
        _translate = QtCore.QCoreApplication.translate
        LoginSuper.setWindowTitle(_translate("LoginSuper", "Form"))
        self.label_5.setText(_translate("LoginSuper", "用户名"))
        self.label_6.setText(_translate("LoginSuper", "密码"))
        self.checkBox.setText(_translate("LoginSuper", "记住密码"))
        self.pushButton.setText(_translate("LoginSuper", "登录"))
        self.pushButton_2.setText(_translate("LoginSuper", "找回密码"))
