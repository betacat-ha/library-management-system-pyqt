...
class Ui_LoginReader(object):
    def setupUi(self, LoginReader):
        LoginReader.setObjectName("LoginReader")
        LoginReader.resize(1250, 809)
        LoginReader.setMinimumSize(QtCore.QSize(700, 500))
        self.horizontalLayout = QtWidgets.QHBoxLayout(LoginReader)
        ...
        self.widget = QtWidgets.QWidget(LoginReader)
...
"}")
        ...
        self.retranslateUi(LoginReader)
        QtCore.QMetaObject.connectSlotsByName(LoginReader)

    def retranslateUi(self, LoginReader):
        _translate = QtCore.QCoreApplication.translate
        LoginReader.setWindowTitle(_translate("LoginReader", "Form"))
        self.label_5.setText(_translate("LoginReader", "学号"))
        self.label_6.setText(_translate("LoginReader", "密码"))
        self.checkBox.setText(_translate("LoginReader", "记住密码"))
        self.pushButton.setText(_translate("LoginReader", "登录"))
        self.pushButton_2.setText(_translate("LoginReader", "找回密码"))
